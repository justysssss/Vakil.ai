...
} from '@/components/landing-page/floating-icon-hero-section'; // Adjust path as needed
...
export default function HeroSection() {
    return (
        <FloatingIconsHero
            title="Vakil.ai — Legal AI Auditor"
            subtitle="High-precision legal auditing for Indian contracts — Textract + Bedrock powered analysis for freelancers and SMBs. Upload a PDF to visualize clause-level risks, redline heatmaps, and suggested safe counter-clauses."
